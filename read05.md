...
- == is equal to (datatype NOT consider)
- != is not equal to (datatype NOT consider)
- === strict equal to (datatype & value consider)
- !== not strict equal to (datatype & value consider)
- (>) Greater Than
- (<) Less Than
